...
// How much of the screen she covers, as a fraction of the tighter dimension.
// It was 0.70, which left her a portrait hung on a wall rather than a head in
// the room -- on a 12.9" iPad that is a third of the glass unused. Per
// character because a portrait cropped tight at the chin and one with shoulders
// in frame do not want the same number.
const FILL = F.fill == null ? 0.98 : F.fill;
...
class Component extends DCLogic {
  ...
  frame(t, now) {
    ...
    const cyp = eink
      ...
      : h * 0.47 + Math.sin(t * 0.47) * 5 * this.dpr * alive - Math.sin(s.nod * Math.PI) * 22 * this.dpr;
