...
"Read arisu/.claude/HANDOFF.md, open the ChatGPT chat and continue the 3D loop from V3.1b (thinking/talking/nod, baseline arisu_v3_0d.blend). First ask Oscar to approve downloading @pixiv/three-vrm-animation for the runtime check."
