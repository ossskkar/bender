...
"Read arisu/.claude/HANDOFF.md, open the ChatGPT chat and continue the 3D loop from V3.1d (thinking with curled fingers, baseline arisu_v3_0d.blend). Measure thinking per frame over ALL finger bone tails (scratch v31c.py pattern): mouth-box crossing, behind-chin-plane penetration, contacts. First ask Oscar to approve downloading @pixiv/three-vrm-animation for the runtime check."
